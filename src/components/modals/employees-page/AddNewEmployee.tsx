        ...
        <div className="bg-white py-6 px-5 rounded-lg w-[90%] space-y-1 lg:max-w-145 lg:p-8 max-h-150 activity overflow-y-scroll">
          ...
          <form className="space-y-2 mt-5 lg:space-y-4">
            ...
            <div className="flex w-full flex-col gap-3 md:flex-row md:items-center">
              ...
              <Input label="role / position" type="text" name="role" />
            </div>
            {/* dept & country */}
            <div className="flex w-full flex-col gap-3 md:flex-row md:items-center">
              <Input label="department" type="text" name="department" />
            ...
            <div className="flex items-center h-12.5 gap-x-2 mt-7 md:w-100 md:place-self-end">
              <div className="h-full w-full px-5 flex items-center justify-center border rounded-xl border-gray-200 capitalize hover:bg-[#2A9290]/10 transition ease-in-out delay-100 cursor-pointer font-medium md:w-[40%]">
                cancel
              </div>
              <button className="w-full capitalize h-full rounded-xl bg-[#2A9290] hover:bg-[#242d3b] text-white focus:outline-none cursor-pointer transition ease-in-out delay-100 disabled:bg-gray-300 disabled:cursor-not-allowed md:w-[60%]">
                add employee
              </button>
            </div>
          </form>
